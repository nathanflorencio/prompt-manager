...
describe('SidebarContent', () => {
  ...
  describe('Collapse / Expand', () => {
    ...
    it('should expand again when click on expand button', async () => {
      makeSut();
      const collapseButton = screen.getByRole('button', {
        name: /minimizar sidebar/i,
      });
  ...
  describe('Search', () => {
    ...
    it('should submit form when user type on search input field', async () => {
    ...
    it('should submit automatically on mount if has query in URL', () => {
      const submitSpy = jest
        .spyOn(HTMLFormElement.prototype, 'requestSubmit')
        .mockImplementation(() => undefined);
      const text = 'text';
  ...
  it('should init search input field with search param', async () => {
    const text = 'initial';
    const searchParams = new URLSearchParams(`q=${text}`);
    mockSearchParams = searchParams;
    makeSut();
